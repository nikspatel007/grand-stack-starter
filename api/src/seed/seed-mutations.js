export default /* GraphQL */ `
  mutation {
    ...
    t1b1: AddTowerLocatedIn(from: { id: "befa11e3-95a2-4a77-94f9-eaabb6c14b78" }, to: { id: "5be279d2-0c92-40dc-9f22-9fc91e87379a" }) {
      from {
        id
      }
    }
    ...
    f4: CreateFloor(id: "ccf840c9-9703-47a3-9011-a3af830c579f", code:"F02M", name:"Level 02", description: "Level 02 Mezzanine", elevation: "-34'-7\"") {
      id
      name
      description
      elevation
    }
    f4: CreateFloor(id: "679617fa-887b-4738-8e22-68f625aa6be4", code:"F03", name:"Level 03", description: "Level 03", elevation: "-46'-2\"") {
      id
      name
      description
      elevation
